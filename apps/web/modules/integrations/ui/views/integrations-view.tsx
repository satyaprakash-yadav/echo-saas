...
export const IntegrationsView = () => {
    ...
    const handleIntegrationClick = (integarationId: IntegrationId) => {
        if (!organization) {
            toast.error("Organization Id not found");
            return;
        };

        const snippet = createScript(integarationId, organization.id);
                ...
                <div className="mx-auto w-full max-w-screen-md">
                    ...
                    <div className="space-y-6">
                        <div className="space-y-1">
                            <Label className="text-lg">Integarations</Label>
...
export const IntegarationsDialog = ({
    open,
    snippet,
    onOpenChange,
}: {
                ...
                <div className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <div className="group relative">
                            ...
                            <Button className="absolute top-4 right-6 size-6 opacity-0 transition-opacity group-hover:opacity-100"
                                onClick={handleCopy}
                                size="icon"
                                variant="secondary"
                            >
